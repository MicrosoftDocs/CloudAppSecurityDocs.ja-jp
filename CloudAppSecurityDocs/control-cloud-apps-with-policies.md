---
title: ポリシーを作成してクラウド アプリの使用を制御する
...
**[ポリシー]** ページを見ると、さまざまなポリシーとテンプレートを種類とアイコンで区別して、使用可能なポリシーを確認できます。 ポリシーは、 **[すべてのポリシー]** タブでまとめて、またはそれぞれのカテゴリのタブで、表示することができます。 使用可能なポリシーは、データ ソースと、組織の Cloud App Security で有効にしたものによって異なります。 たとえば、Cloud Discovery ログをアップロードした場合、Cloud Discovery に関連するポリシーが表示されます。

次の種類のポリシーを作成できます。

|ポリシーの種類アイコン|ポリシーの種類|カテゴリ|使用|
|-----|---------|--------|---------|
|![アクティビティ ポリシー アイコン](media/activity-policy.png)|アクティビティ ポリシー|脅威の検出|アクティビティ ポリシーにより、アプリ プロバイダーの API を使用して、幅広い自動プロセスを適用できます。 これらのポリシーにより、さまざまなユーザーによって実行される特定のアクティビティを監視したり、予期しない高い割合の特定の種類のアクティビティを追跡したりできます。 [詳細情報](user-activity-policies.md)|
|![異常検出ポリシー アイコン](media/anomaly-detection-policy.png)|異常検出ポリシー|脅威の検出|異常検出ポリシーにより、クラウド上の異常なアクティビティを探すことができます。 検出は、組織のベースラインまたはユーザーの通常のアクティビティと異なる何かが発生したときに警告させるように設定した、リスク要因に基づきます。 [詳細情報](anomaly-detection-policy.md)|
|![OAuth アプリ ポリシー アイコン](media/oauth-policy.png)|OAuth アプリ ポリシー|脅威の検出|OAuth アプリ ポリシーを使用すると、各 OAuth アプリによって要求されたアクセス許可を調査し、自動的に承認または破棄することができます。 これらは Cloud App Security に付属する組み込みのポリシーであり、作成することはできません。 [詳細情報](app-permission-policy.md)|
|![マルウェア検出ポリシー アイコン](media/malware-detection-policy.png)|マルウェアの検出ポリシー|脅威の検出|マルウェア検出ポリシーを使用すると、クラウドのストレージ内で悪意のあるファイルを識別し、それを自動的に承認または破棄することができます。 これは Cloud App Security に付属する組み込みのポリシーであり、作成することはできません。 [詳細情報](anomaly-detection-policy.md#malware-detection)|
|![ファイル ポリシー アイコン](media/file-policy.png)|[ファイル ポリシー]|情報の保護|ファイル ポリシーにより、クラウド アプリをスキャンし、指定したファイルまたはファイルの種類 (共有、外部ドメインとの共有)、データ (機密情報、個人データ、クレジット カード情報、その他の種類のデータ) を監視して、ファイルにガバナンス アクションを適用できます (ガバナンス アクションはクラウドアプリごとに異なります)。 [詳細情報](data-protection-policies.md)|
|![アクセス ポリシー アイコン](media/proxy-policy.png)|アクセス ポリシー|条件付きアクセス|アクセス ポリシーにより、リアルタイム監視と、クラウド アプリへのユーザー ログインの制御が可能になります。 [詳細情報](access-policy-aad.md)|
|![セッション ポリシー アイコン](media/proxy-policy.png)|セッション ポリシー|条件付きアクセス|セッション ポリシーにより、リアルタイム監視と、クラウド アプリでのユーザー アクティビティの制御が可能になります。 [詳細情報](session-policy-aad.md)|
|![Cloud Discovery ポリシー アイコン](media/discovery-policy.png)|アプリ検出ポリシー|シャドウ IT|アプリ検出ポリシーにより、組織内で新しいアプリが検出されたときに通知させるアラートを設定できます。 [詳細情報](cloud-discovery-policies.md)|
|![異常検出ポリシー アイコン](media/anomaly-detection-policy.png)|Cloud Discovery 異常検出ポリシー|シャドウ IT|Cloud Discovery 異常検出ポリシーでは、クラウド アプリを探索し、異常の発生を探すために使用するログが調査されます。 たとえば、それまで Dropbox を使用したことがないユーザーが突然 600 GB を Dropbox にアップロードした場合や、特定のアプリで通常よりもかなり多くのトランザクションが発生した場合などです。 [詳細情報](cloud-discovery-anomaly-detection-policy.md)|
...
1. 使用するテンプレートの行の右端にあるプラス記号 **[+]** をクリックします。 テンプレートの定義済みの構成を含むポリシーの作成ページが開きます。
