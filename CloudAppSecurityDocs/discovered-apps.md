...
1. **[除外されたユーザー]** 、 **[除外された IP アドレス]** 、または **[Excluded devices]\(除外されたデバイス\)** タブのいずれかを選択し、[+] ボタンをクリックして除外を追加します。

1. ユーザーのエイリアス、IP アドレス、またはデバイス名を追加します。 除外した理由に関する情報を追加することをお勧めします。
