...
| | AWS | Azure| ボックス | ドロップボックス | GitHub | GCP | Google Workspace | Office 365 | Okta | Service Now | Salesforce | Webex | Workday |
| - | - | - | - | - | - | - | - | - | - | - | - | - | - |
...
> - これらのステップを使用してアプリの条件付きアクセス制御アプリとセキュリティ構成アプリを無効にすることはできません。
